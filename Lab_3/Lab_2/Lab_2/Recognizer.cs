...
namespace DigitRecognition
{
    public class Recognizer
    {
        ...
        public void GetResults(List<string> pics)
        {           
            var pairList = new List<Tuple<Image<Rgb24>, string>>();
            foreach (var picture in pics) //проходим по файлам
            {
                //получаем расширение файла и проверяем подходит ли оно нам                 
                pairList.Add(new Tuple<Image<Rgb24>, string>(Image.Load<Rgb24>(picture), picture));
            }
